...
## From source install
```
Package: Open MPI hpc@hpc1 Distribution
                Open MPI: 4.0.3
  Open MPI repo revision: v4.0.3
   Open MPI release date: Mar 03, 2020
                Open RTE: 4.0.3
 ...
 Configured architecture: x86_64-unknown-linux-gnu
          Configure host: hpc1
           Configured by: hpc
           Configured on: Fri Feb 16 01:59:11 PST 2024
          Configure host: hpc1
  Configure command line: '--prefix=/usr/local'
                Built by: root
                Built on: Fri 16 Feb 2024 02:19:59 AM PST
              Built host: hpc1
              C bindings: yes
            C++ bindings: no
             Fort mpif.h: yes (all)
  ...
  MPI_MAX_DATAREP_STRING: 128
           ...
           MCA backtrace: execinfo (MCA v2.1.0, API v2.0.0, Component v4.0.3)
            ...
            MCA compress: bzip (MCA v2.1.0, API v2.0.0, Component v4.0.3)
               ...
               MCA event: libevent2022 (MCA v2.1.0, API v2.0.0, Component
                          v4.0.3)
               MCA hwloc: hwloc201 (MCA v2.1.0, API v2.0.0, Component v4.0.3)
                  MCA if: linux_ipv6 (MCA v2.1.0, API v2.0.0, Component
                          v4.0.3)
                  MCA if: posix_ipv4 (MCA v2.1.0, API v2.0.0, Component
                          v4.0.3)
         ...
         MCA installdirs: config (MCA v2.1.0, API v2.0.0, Component v4.0.3)
             ...
             MCA patcher: overwrite (MCA v2.1.0, API v1.0.0, Component
                          v4.0.3)
                MCA pmix: flux (MCA v2.1.0, API v2.0.0, Component v4.0.3)
                MCA pmix: pmix3x (MCA v2.1.0, API v2.0.0, Component v4.0.3)
                MCA pmix: isolated (MCA v2.1.0, API v2.0.0, Component v4.0.3)
               MCA pstat: linux (MCA v2.1.0, API v2.0.0, Component v4.0.3)
              MCA rcache: grdma (MCA v2.1.0, API v3.3.0, Component v4.0.3)
           MCA reachable: weighted (MCA v2.1.0, API v2.0.0, Component v4.0.3)
